                            ...
                            cudaStream_t stream)
{
	...
	cudaMemcpyAsync(knodesD, knodes, knodes_mem, cudaMemcpyHostToDevice,
            stream);
	...
	cudaMemcpyAsync(currKnodeD, currKnode, count*sizeof(long),
	...
	cudaMemcpyAsync(offsetD, offset, count*sizeof(long),
            cudaMemcpyHostToDevice, stream);
	...
	cudaMemcpyAsync(lastKnodeD, lastKnode, count*sizeof(long),
            cudaMemcpyHostToDevice, stream);
	...
	cudaMemcpyAsync(offset_2D, offset_2, count*sizeof(long),
            cudaMemcpyHostToDevice, stream);
	...
	cudaMemcpyAsync(startD, start, count*sizeof(int), cudaMemcpyHostToDevice,
            stream);
	...
	cudaMemcpyAsync(endD, end, count*sizeof(int), cudaMemcpyHostToDevice,
            stream);
	...
	cudaMemcpyAsync(ansDStart, recstart, count*sizeof(int),
            cudaMemcpyHostToDevice, stream);
	...
	cudaMemcpyAsync(ansDLength, reclength, count*sizeof(int),
            cudaMemcpyHostToDevice, stream);
	...
	findRangeK<<<numBlocks, threadsPerBlock, 0, stream>>>(	maxheight,
                                                            knodesD,
                                                            knodes_elem,
	...
	cudaMemcpyAsync(recstart, ansDStart, count*sizeof(int),
	...
	cudaMemcpyAsync(reclength, ansDLength, count*sizeof(int),
            cudaMemcpyDeviceToHost, stream);
	checkCUDAError("cudaMemcpy ansDLength");
