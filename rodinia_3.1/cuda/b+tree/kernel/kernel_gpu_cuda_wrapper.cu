                        ...
                        cudaStream_t stream)
{
	...
	cudaMemcpyAsync(recordsD, records, records_mem, cudaMemcpyHostToDevice,
            stream);
	...
	cudaMemcpyAsync(keysD, keys, count*sizeof(int), cudaMemcpyHostToDevice,
            stream);
	...
	cudaMemcpyAsync(ansD, ans, count*sizeof(record), cudaMemcpyHostToDevice,
            stream);
	...
	findK<<<numBlocks, threadsPerBlock, 0, stream>>>(	maxheight,
	...
	cudaMemcpyAsync(ans, ansD, count*sizeof(record), cudaMemcpyDeviceToHost,
            stream);
