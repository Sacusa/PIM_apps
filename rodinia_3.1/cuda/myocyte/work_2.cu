...
int work_2(	int xmax,
	...
	cudaMemcpyAsync(d_x, x, x_mem, cudaMemcpyHostToDevice, stream);
	...
	cudaMemcpyAsync(d_y, y, y_mem, cudaMemcpyHostToDevice, stream);
	...
	cudaMemcpyAsync(d_params, params, params_mem, cudaMemcpyHostToDevice, stream);
	...
	solver_2<<<blocks, threads, 0, stream>>>(	workload,
																xmax,
	...
	cudaMemcpyAsync(x, d_x, x_mem, cudaMemcpyDeviceToHost, stream);
	cudaMemcpyAsync(y, d_y, y_mem, cudaMemcpyDeviceToHost, stream);
    cudaStreamSynchronize(stream);
