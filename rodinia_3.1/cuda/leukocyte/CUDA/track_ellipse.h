...
extern void ellipsetrack(avi_t *video, double *xc0, double *yc0, int num_centers, int R, int Np, int Nf, cudaStream_t stream);
extern MAT **MGVF(MAT **I, double vx, double vy, int Nc, cudaStream_t stream);
